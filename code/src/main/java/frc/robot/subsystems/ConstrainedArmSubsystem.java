...
public class ConstrainedArmSubsystem extends SubsystemBase {
  ...
  public static Angle angleOffset = Rotations.of(RobotBase.isSimulation() ? 0 : -0.397); //-0.144 the encoder value - 0.25 for standard position.
  ...
  public static double gearboxRatio = 5 * 5;
